...
public interface ReviewRepository extends JpaRepository<ReviewVO, Object> {
    ...
    @Query(nativeQuery=true,
            value="select m.name, r.shop_name , r.review_star, r.review_id, r.shop_id, r.created_at, r.review_coment, r.review_pic, r.user_id  "
    ...
    @Query(nativeQuery=true,
            value="select s.shop_name, r.name, r.review_star, r.review_id, r.shop_id, r.created_at, r.review_coment, r.review_pic, r.user_id  "
